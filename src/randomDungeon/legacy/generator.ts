...
import { DIRECTIONS, hallwayFootprint, intersectionFootprint, oppositeDirection, perimeterExits, roomFromEntrance, roomFootprint, step, turnLeft, turnRight, uniquePoints } from './geometry'
import { PlacementLedger } from './placement'
import { conditionLabelText, placeGeneratedLabel } from './labels'
import { makeGeneratedStamp, type StampSemantic } from './stamps'
import { summarizeGeneration } from './summary'
import type { AppSnapshotShape, Direction, DoorwayRecord, ExitRecord, FeatureType, GenerationAttempt, GenerationInput, GenerationResult, GeneratedLabelRecord, GeneratedStampRecord, HallwayCondition, HallwayForm, HallwayRecord, IntersectionRecord, Point, RoomRecord, RoomShape, StartingLocation } from './types'
...
function generateLegacyRandomDungeon(input: GenerationInput): GenerationResult {
...
export { generateLegacyRandomDungeon }
